...
To train the agents run the following command (change the filename to match your downloaded environment):

```bash
python3 train.py --filename Tennis_Linux_NoVis/Tennis.x86_64
```

To run the trained agent run the following command (change the filename to match your downloaded environment):

```
python3 run.py --filename Tennis_Linux_NoVis/Tennis.x86_64
```
